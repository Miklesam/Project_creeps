...
class HealthBar(val creep: Creep, val context: Context) {
    ...
    init {
        ...
        margin = 2
        borderPaint = Paint()
        val borderColor = ContextCompat.getColor(context, R.color.healthBarRadiantBorder)
